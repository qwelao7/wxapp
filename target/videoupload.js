  ...
  $.extend($, {
    fileUpload: function (options) {
      var para = {
        ...
        uploadButton: null,
        //url: "/home/MUploadImg",
        url: "https://app-img.huilaila.net:7889/xcx/upload?type=video",
        base64strUrl: "/home/MUploadImgBase64Str",
        //filebase: "mfile",//mvc后台需要对应的名称
        filebase: "file",//mvc后台需要对应的名称
        auto: true,
        previewZoom: null,
        imgList:[],
      ...
      var inputstr = '<input id="fileImage"  style="opacity:0;position:absolute;top: 0;left: 0;width:100%;height:100%" type="file" size="30" name="fileselect[]">';
